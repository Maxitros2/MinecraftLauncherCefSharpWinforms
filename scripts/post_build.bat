...
XCOPY /S /Y /F "%PROJECTDIR%\Translations\*" "%TARGETDIR%\Brolauncher-langs\"
...
7z a "%TARGETDIR%\FreeLauncher.zip" "%TARGETDIR%\FreeLauncher.exe" "%TARGETDIR%\Brolauncher-langs\" -r
IF NOT DEFINED DLLS (
	GOTO FINISH
)
